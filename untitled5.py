...
high_risk_flag = (
    pregnancies >= thresholds["pregnancies"] or
    glucose >= thresholds["glucose"] or
    blood_pressure >= thresholds["blood_pressure"] or
    skin_thickness >= thresholds["skin_thickness"] or
    insulin >= thresholds["insulin"] or
    bmi >= thresholds["bmi"] or
    dpf >= thresholds["dpf"] or
    age >= thresholds["age"]
)

if st.sidebar.button("Predict"):
    if high_risk_flag:
        st.error("High Risk of Diabetes (based on threshold rule)")
    else:
